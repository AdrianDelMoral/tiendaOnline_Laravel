<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                {{ __('Cuando la autenticación de dos factores está habilitada, se solicitará un token seguro y aleatorio durante la autenticación. Se puede recuperar este token de la aplicación Google Authenticator de su teléfono.') }}
            </p>
        </div>
