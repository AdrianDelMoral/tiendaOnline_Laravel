<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Administra y cierra sesión en sus sesiones activas en otros navegadores y dispositivos.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Ingresa tu contraseña para confirmar que quiere cerrar sesión en sus otras sesiones de navegador en todos sus dispositivos.') }}
